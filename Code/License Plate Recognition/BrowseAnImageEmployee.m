function varargout = BrowseAnImageEmployee(varargin)
% BROWSEANIMAGEEMPLOYEE MATLAB code for BrowseAnImageEmployee.fig
%      BROWSEANIMAGEEMPLOYEE, by itself, creates a new BROWSEANIMAGEEMPLOYEE or raises the existing
%      singleton*.
%
%      H = BROWSEANIMAGEEMPLOYEE returns the handle to a new BROWSEANIMAGEEMPLOYEE or the handle to
%      the existing singleton*.
%
%      BROWSEANIMAGEEMPLOYEE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BROWSEANIMAGEEMPLOYEE.M with the given input arguments.
%
%      BROWSEANIMAGEEMPLOYEE('Property','Value',...) creates a new BROWSEANIMAGEEMPLOYEE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before BrowseAnImageEmployee_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to BrowseAnImageEmployee_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help BrowseAnImageEmployee

% Last Modified by GUIDE v2.5 21-Jul-2019 18:07:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @BrowseAnImageEmployee_OpeningFcn, ...
                   'gui_OutputFcn',  @BrowseAnImageEmployee_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before BrowseAnImageEmployee is made visible.
function BrowseAnImageEmployee_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to BrowseAnImageEmployee (see VARARGIN)

% Choose default command line output for BrowseAnImageEmployee
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes BrowseAnImageEmployee wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = BrowseAnImageEmployee_OutputFcn(hObject, eventdata, handles) 
